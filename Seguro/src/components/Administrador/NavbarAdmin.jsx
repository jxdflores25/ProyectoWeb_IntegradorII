...
const NavbarAdmin = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 py-3 backdrop-blur-lg border-b border-neutral-700/80">
      <div className="container px-4 mx-auto relative text-sm">
        <div className="flex justify-between items-center">
          <div className="flex items-center flex-shrink-0">
            <span className="text-2xl tracking-tight text-celeste flex gap-1">
              Health <span className="text-verde">Express</span> <IconLogo />
            </span>
          </div>
                ...
                <NavLink
                  ...
                  className={
                    activeMenuIndex === index
                      ? "bg-gradient-to-r from-blue-200 to-verdesuave px-4 py-2 rounded"
                      : ""
                  }>
                  {item.label}
                </NavLink>
              ...
              {navItemsAdmin.map((item, index) => (
                <li key={index} className="py-3 border-b-2 border-celeste">
                  <NavLink
                    ...
                    className={
                      activeMenuIndex === index
                        ? "bg-gradient-to-r from-blue-200 to-verdesuave"
                        : ""
                    }>
                    {item.label}
                  </NavLink>
      ...
      <div
        id="menu-backdrop"
        className={`absolute bg-gradient-to-r from-blue-200 to-verdesuave backdrop-blur-lg rounded
