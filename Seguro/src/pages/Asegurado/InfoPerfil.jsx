...
const InfoPerfil = ({ Data }) => {
  ...
  const handleRegistration = async (event) => {
    ...
    if (passwordStrength !== "muy fuerte") {
      toast.warning(
        "La contraseña debe tener al menos 12 caracteres, una letra mayúscula, un número y un caracter especial."
      );
  ...
  return (
    <div className="flex flex-col items-center justify-center bg-white shadow-md rounded-lg p-8 w-full border border-gray-300">
      ...
      <form>
        ...
        <div className="mt-6 z-10" data-tooltip-id="mapa">
          <label
            htmlFor="Mapa"
            className="block text-sm font-medium text-gray-700">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 mt-6">
          <div>
            ...
            <button
              ...
              className="text-sm font-medium text-celeste">
